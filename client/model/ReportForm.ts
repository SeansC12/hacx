...
export const exampleIncidentReport: ReportForm = {
  ...
  description: 'Please provide detailed information about the incident and your contact details.',
  sections: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          formInput: {
            ...
            description: 'Please provide the complete address where the incident took place',
            input: { type: 'address' }
          }
        },
        {
